...
|---|-----|-------|--------------|--------|
| 05 | [Static Routing Between Two Routers](./05-static-routing-two-router/) | Point-to-point static routing | Next-hop = far end of link, return-path symmetry, `/30` WAN sizing, TTL as path evidence | ✅ Complete |
